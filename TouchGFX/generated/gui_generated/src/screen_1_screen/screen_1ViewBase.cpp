    ...
    flexButtonCallback(this, &screen_1ViewBase::flexButtonCallbackHandler)
{
    ...
    circle1.setPosition(56, 285, 80, 80);
    circle1.setCenter(40, 40);
    circle1.setRadius(40);
    circle1.setLineWidth(0);
    circle1.setArc(0, 360);
    circle1Painter.setColor(touchgfx::Color::getColorFromRGB(255, 62, 48));
    circle1.setPainter(circle1Painter);
    add(circle1);

    shape1.setPosition(200, 285, 80, 80);
    shape1.setOrigin(0.0f, 0.0f);
    shape1.setScale(1.0f, 1.0f);
    shape1.setAngle(0.0f);
    shape1Painter.setColor(touchgfx::Color::getColorFromRGB(56, 245, 113));
    ...
    box2.setPosition(352, 290, 75, 70);
    box2.setColor(touchgfx::Color::getColorFromRGB(20, 46, 245));
    add(box2);
}
