...
#ifndef __TOUCH_CONTROLLER_HPP
#define __TOUCH_CONTROLLER_HPP  0103 /* BSP Touch API REVISION v.1.3 */

#ifdef st1x33i_240x240
/* Maximum border values of the touchscreen pad */
#define  ST_1633I_MAX_WIDTH              ((uint16_t)240)     /* Touchscreen pad max width   */
#define  ST_1633I_MAX_HEIGHT             ((uint16_t)240)    /* Touchscreen pad max height  */

/* Touchscreen pad max width and height values for FT6xx6 Touch*/
#define  ST_1633I_MAX_WIDTH_HEIGHT       ((uint16_t)240)
